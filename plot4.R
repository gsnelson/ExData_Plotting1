...
##  P l o t  1  ##  (Upper Right)  #############################################
## plot the Voltage Power values
with(power_subset,
	 plot(
	 	Voltage ~ DateTime,
	 	lwd = 1,
...
## plot the energy sub-metering No. 2 & energy sub-metering No. 2 values
lines(
	power_subset$Sub_metering_2 ~ power_subset$DateTime,
	lwd = 1,
	type = "l",
	col = "red"
)
...
##  P l o t  4  ##  (Lower Right)  #############################################
## plot the Global Reactive Power values
with(power_subset,
	 plot(
